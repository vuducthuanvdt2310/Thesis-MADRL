...
def solve_pure_milp(horizon=23, time_limit_sec=10000):
    # ==========================================
    ...
    if prob.status == 1:
        ...
        # Save Outputs
        save_dir = Path("evaluation_results/milp_benchmark_small")
        ...
        # 2. Save CSV Metrics
        import csv
        csv_path = save_dir / f"results_milp.csv"
