...
Replicates train_multi_dc_gnn.py but uses configs/multi_dc_4x15_config.yaml.
"""
...
if __name__ == "__main__":
    ...
    # DEFAULT CONFIGURATION for 4x15 scale
    parser.set_defaults(
        env_name="MultiDC",
        ...
        experiment_name="gnn_happo_4x15",
        use_eval=True,
    ...
    print("=" * 70)
    print(f"GNN-HAPPO Training — 4x15 ({N_DCS} DCs + {N_RETAILERS} Retailers)")
    print("=" * 70)
