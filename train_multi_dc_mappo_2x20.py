#!/usr/bin/env python
"""
MAPPO Training Script for 2x20 Inventory Environment
...
if __name__ == "__main__":
    ...
    parser = get_config()
    parser.set_defaults(
        env_name="MultiDC", scenario_name="inventory_2echelon_2x20",
        num_agents=N_AGENTS, episode_length=365, num_env_steps=36500000,
        n_rollout_threads=4, n_training_threads=1,
        algorithm_name="mappo", experiment_name="mappo_2x20",
    ...
    print("=" * 70)
    print(f"MAPPO Training — 2x20 ({N_DCS} DCs + {N_RETAILERS} Retailers)")
    print("=" * 70)
