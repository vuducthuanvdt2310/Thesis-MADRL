#!/usr/bin/env python
"""
Test/Evaluation Script for Trained HAPPO Models -- 1 DC x 10 Retailer Scale

Subclasses HAPPOEvaluator2x30 to reuse its topology-aware episode runner.

Usage:
    python test_trained_model_happo_1x10.py \
        --model_dir results/happo_1x10/run_seed_1/models \
...
class HAPPOEvaluator1x10(HAPPOEvaluator2x30):
    """HAPPO evaluator for the 1 DC x 10 Retailer environment."""
    ...
    def _save_metrics_csv(self):
        ...
        results_path = self.save_dir / 'results_standard_happo_1x10.csv'
    ...
    def _print_summary(self, stats):
        print('\n' + '=' * 70)
        print('HAPPO Evaluation Summary -- 1x10 Scale')
        print('=' * 70)
...
def main():
    ...
    evaluator = HAPPOEvaluator1x10(args)
    evaluator.evaluate()
