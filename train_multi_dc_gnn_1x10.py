...
Topology: 1 Supplier → 1 DC → 10 Retailers (11 agents total)

Replicates train_multi_dc_gnn.py but uses configs/multi_dc_1x10_config.yaml.
"""
...
if __name__ == "__main__":
    ...
    # DEFAULT CONFIGURATION for 1x10 scale
    parser.set_defaults(
        env_name="MultiDC",
        ...
        experiment_name="gnn_happo_1x10",
        use_eval=True,
    ...
    print("=" * 70)
    print(f"GNN-HAPPO Training — 1x10 ({N_DCS} DC + {N_RETAILERS} Retailers)")
    print("=" * 70)
