#!/usr/bin/env python
"""
MAPPO Training Script for 1x3 Inventory Environment
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print(f"MAPPO Training — 1x3 ({N_DCS} DC + {N_RETAILERS} Retailers)")
    print("=" * 70)
