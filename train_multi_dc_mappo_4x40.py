#!/usr/bin/env python
"""
MAPPO Training Script for 4×40 Inventory Environment
...
if __name__ == "__main__":
    ...
    parser = get_config()
    parser.set_defaults(
        env_name="MultiDC", scenario_name="inventory_2echelon_4x40",
    ...
    print("=" * 70)
    print(f"MAPPO Training — 4x40 ({N_DCS} DCs + {N_RETAILERS} Retailers)")
    print("=" * 70)
