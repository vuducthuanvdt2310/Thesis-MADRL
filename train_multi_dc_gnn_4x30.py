...
Topology: 1 Supplier → 4 DCs → 30 Retailers (34 agents total)

Replicates train_multi_dc_gnn.py but uses configs/multi_dc_4x30_config.yaml.
"""
...
if __name__ == "__main__":
    ...
    # DEFAULT CONFIGURATION for 4x30 scale
    parser.set_defaults(
        env_name="MultiDC",
        ...
        experiment_name="gnn_happo_4x30",
        use_eval=True,
    ...
    print("=" * 70)
    print(f"GNN-HAPPO Training — 4x30 ({N_DCS} DCs + {N_RETAILERS} Retailers)")
    print("=" * 70)
