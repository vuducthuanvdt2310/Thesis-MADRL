#!/usr/bin/env python
"""
Test/Evaluation Script for Trained MAPPO Models -- 2 DC x 30 Retailer Scale
============================================================================
...
override (formerly delegated to ``test_evaluator_topology.py``).

Usage:
    python test_trained_model_mappo_2x30.py \
        --model_dir results/mappo_2x30/run_seed_1/models \
...
class MAPPOEvaluator2x30(ModelEvaluator):
    """MAPPO evaluator for the 2 DC x 30 Retailer environment.

    Inherits directly from ``ModelEvaluator`` and inlines all
    topology-aware overrides so that no intermediate base class is needed.
    """
    ...
    def __init__(self, args):
        # Set topology and algorithm *before* the parent __init__ calls
        # _create_env / _load_models.
        self.n_dcs = N_DCS
    ...
    def _run_episode(self, episode_num, save_trajectory=False):
        ...
        Full copy of the topology-aware runner with every hardcoded DC-count
    ...
    def _save_metrics_csv(self):
        ...
        results_path = self.save_dir / 'results_standard_mappo_2x30.csv'
    ...
    def _print_summary(self, stats):
        print('\n' + '=' * 70)
        print('MAPPO Evaluation Summary — 2x30 Scale')
        print('=' * 70)
...
def main():
    ...
    evaluator = MAPPOEvaluator2x30(args)
    evaluator.evaluate()
