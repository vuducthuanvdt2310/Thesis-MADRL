#!/usr/bin/env python
"""
GNN-HAPPO Training Script for SMALL Multi-DC Inventory Environment
Topology: 1 Supplier → 1 DC → 7 Retailers (8 agents total)

Replicates train_multi_dc_gnn.py but uses configs/multi_dc_1x7_config.yaml.
"""
...
if __name__ == "__main__":
    ...
    # DEFAULT CONFIGURATION for 1x7 scale
    parser.set_defaults(
        env_name="MultiDC",
    ...
    print("=" * 70)
    print("GNN-HAPPO Training — 1×7 (1 DC + 7 Retailers)")
    print("=" * 70)
    print(f"Config          : {CONFIG_PATH}")
    print(f"Agents          : {N_AGENTS} ({N_DCS} DC + {N_RETAILERS} Retailers)")
