...
Topology: 1 Supplier → 2 DCs → 20 Retailers (22 agents total)

Replicates train_multi_dc_gnn.py but uses configs/multi_dc_2x20_config.yaml.
"""
...
if __name__ == "__main__":
    ...
    # DEFAULT CONFIGURATION for 2x20 scale
    parser.set_defaults(
        env_name="MultiDC",
        ...
        experiment_name="gnn_happo_2x20",
        use_eval=True,
    ...
    print("=" * 70)
    print(f"GNN-HAPPO Training — 2x20 ({N_DCS} DCs + {N_RETAILERS} Retailers)")
    print("=" * 70)
