#!/usr/bin/env python
"""
Test/Evaluation Script for Trained MAPPO Models -- 4 DC x 15 Retailer Scale

Subclasses MAPPOEvaluator2x30 to reuse its topology-aware episode runner.

Usage:
    python test_trained_model_mappo_4x15.py \
        --model_dir results/mappo_4x15/run_seed_1/models \
...
class MAPPOEvaluator4x15(MAPPOEvaluator2x30):
    """MAPPO evaluator for the 4 DC x 15 Retailer environment."""
    ...
    def _create_env(self):
        print('Creating evaluation environment (4x15 scale)...')
        parser = get_config()
        parser.set_defaults(
            env_name='MultiDC',
    ...
    def _save_metrics_csv(self):
        ...
        results_path = self.save_dir / 'results_standard_mappo_4x15.csv'
    ...
    def _print_summary(self, stats):
        print('\n' + '=' * 70)
        print('MAPPO Evaluation Summary -- 4x15 Scale')
        print('=' * 70)
...
def main():
    ...
    evaluator = MAPPOEvaluator4x15(args)
    evaluator.evaluate()
