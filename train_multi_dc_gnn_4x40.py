...
Replicates train_multi_dc_gnn.py but uses configs/multi_dc_4x40_config.yaml.
"""
...
if __name__ == "__main__":
    ...
    # DEFAULT CONFIGURATION for 4x40 scale
    parser.set_defaults(
        env_name="MultiDC",
        ...
        experiment_name="gnn_happo_4x40",
        use_eval=True,
    ...
    print("=" * 70)
    print("GNN-HAPPO Training — SCALED 4×40 (Proposed Method)")
    print("=" * 70)
