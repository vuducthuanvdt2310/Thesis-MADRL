#!/usr/bin/env python
"""
Test/Evaluation Script for Trained HAPPO Models -- 2 DC x 40 Retailer Scale

Subclasses HAPPOEvaluator2x30 to reuse its topology-aware episode runner.

Usage:
    python test_trained_model_happo_2x40.py \
        --model_dir results/happo_2x40/run_seed_1/models \
...
class HAPPOEvaluator2x40(HAPPOEvaluator2x30):
    """HAPPO evaluator for the 2 DC x 40 Retailer environment."""
    ...
    def _save_metrics_csv(self):
        ...
        results_path = self.save_dir / 'results_standard_happo_2x40.csv'
    ...
    def _print_summary(self, stats):
        print('\n' + '=' * 70)
        print('HAPPO Evaluation Summary -- 2x40 Scale')
        print('=' * 70)
...
def main():
    ...
    evaluator = HAPPOEvaluator2x40(args)
    evaluator.evaluate()
