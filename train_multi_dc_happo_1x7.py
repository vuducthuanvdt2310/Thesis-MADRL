#!/usr/bin/env python
"""
HAPPO Training Script for 1×7 Inventory Environment
Topology: 1 Supplier → 1 DC → 7 Retailers (8 agents total)

Uses the same CRunner as the 2×15 baseline with HAPPO algorithm.
"""
...
# ================================================================
# ENVIRONMENT CONFIG — 1 DC × 7 Retailers
# ================================================================
N_DCS = 1
N_RETAILERS = 7
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print(f"HAPPO Training — 1x7 ({N_DCS} DC + {N_RETAILERS} Retailers)")
    print("=" * 70)
    ...
    for seed in seeds:
        ...
        print(f"Envs created: {envs.num_envs} parallel | {num_agents} agents | 3D continuous actions\n")
        ...
        try:
            ...
            with open(seed_res_record_file, 'a+') as f:
                ...
                for fluc in bw:
                    f.write(str(fluc) + ' ')
                f.write('\n')
            print(f"\nTraining completed for seed {seed} | Final reward: {reward}")
