#!/usr/bin/env python
"""
Test/Evaluation Script for Trained HAPPO Models -- 4 DC x 15 Retailer Scale

Subclasses HAPPOEvaluator2x30 to reuse its topology-aware episode runner.

Usage:
    python test_trained_model_happo_4x15.py \
        --model_dir results/happo_4x15/run_seed_1/models \
...
class HAPPOEvaluator4x15(HAPPOEvaluator2x30):
    """HAPPO evaluator for the 4 DC x 15 Retailer environment."""
    ...
    def _save_metrics_csv(self):
        ...
        results_path = self.save_dir / 'results_standard_happo_4x15.csv'
    ...
    def _print_summary(self, stats):
        print('\n' + '=' * 70)
        print('HAPPO Evaluation Summary -- 4x15 Scale')
        print('=' * 70)
...
def main():
    ...
    evaluator = HAPPOEvaluator4x15(args)
    evaluator.evaluate()
