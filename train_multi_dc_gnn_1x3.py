...
Topology: 1 Supplier → 1 DC → 3 Retailers (4 agents total)

Replicates train_multi_dc_gnn.py but uses configs/multi_dc_1x3_config.yaml.
"""
...
if __name__ == "__main__":
    ...
    # DEFAULT CONFIGURATION for 1x3 scale
    parser.set_defaults(
        env_name="MultiDC",
    ...
    print("=" * 70)
    print(f"GNN-HAPPO Training — 1x3 ({N_DCS} DC + {N_RETAILERS} Retailers)")
    print("=" * 70)
