#!/usr/bin/env python
"""
Test/Evaluation Script for Trained MAPPO Models -- 1 DC x 3 Retailer Scale

Subclasses MAPPOEvaluator2x30 to reuse its topology-aware episode runner.

Usage:
    python test_trained_model_mappo_1x3.py \
        --model_dir results/mappo_1x3/run_seed_1/models \
...
class MAPPOEvaluator1x3(MAPPOEvaluator2x30):
    """MAPPO evaluator for the 1 DC x 3 Retailer environment."""
    ...
    def _save_metrics_csv(self):
        ...
        results_path = self.save_dir / 'results_standard_mappo_1x3.csv'
    ...
    def _print_summary(self, stats):
        print('\n' + '=' * 70)
        print('MAPPO Evaluation Summary -- 1x3 Scale')
        print('=' * 70)
...
def main():
    ...
    evaluator = MAPPOEvaluator1x3(args)
    evaluator.evaluate()
