#!/usr/bin/env python
"""
MAPPO Training Script for 1×7 Inventory Environment
Topology: 1 Supplier → 1 DC → 7 Retailers (8 agents total)

MAPPO uses a centralized critic with independent PPO actors (no sequential
importance-weight factor between agents, unlike HAPPO).
"""
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print(f"MAPPO Training — 1x7 ({N_DCS} DC + {N_RETAILERS} Retailers)")
    print("=" * 70)
